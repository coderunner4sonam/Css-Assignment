...
// BodyContent_partfour is divide into FOOD GUIDE & Vegetables section
  ...
  return (
    <>
      ...
      <div className="bodyContent_parttwo" style={bodyContent_parttwo}>
        ...
        {/* Vegetables section */}
        <div
          className="bodyContent_partfour_inner_parent"
          style={bodyContent_partfour_inner_parent}
        >
          <div
            className="bodyContent_partfour_inner_child_one"
            style={bodyContent_partfour_inner_child_one}
          >
            <div
              className="inner_child_one_image1"
              style={inner_child_one_image1}
            >
              <div className="label1" style={label1}>
                <h5>VEGETABLES </h5>
              </div>
            </div>
            <p className="label2" style={label2}>
              Lorem Ipsum is simply dummy text{" "}
            </p>

            <div
              className="inner_child_one_image2"
              style={inner_child_one_image2}
            >
              <div className="label1" style={label1}>
                <h5>VEGETABLES</h5>
              </div>
          ...
          <div
            className="bodyContent_partfour_inner_child_middle"
            style={bodyContent_partfour_inner_child_middle}
          ></div>
          <div
            className="bodyContent_partfour_inner_child_one"
            style={bodyContent_partfour_inner_child_one}
          >
            <div
              className="inner_child_one_image3"
              style={inner_child_one_image3}
            >
              <div className="label1" style={label1}>
                <h5>VEGETABLES</h5>
              </div>
            </div>
            <p className="label2_image3" style={label2_image3}>
              Lorem Ipsum is simply dummy text{" "}
            </p>

            <div
              className="inner_child_one_image4"
              style={inner_child_one_image4}
            >
              <div className="label1" style={label1}>
                <h5>VEGETABLES</h5>
              </div>
            </div>
            <p className="label2_image4p" style={label2_image4p}>
              Lorem Ipsum is simply dummy text{" "}
            </p>
          </div>
        </div>
