...
// This component is use to show  TOP CHEFS & below image content
  ...
  return (
    ...
    {/* // This component is use to show  TOP CHEFS & below image content */}
      ...
      <div className="bodyContent_partthree" style={bodyContent_partthree}>
        <div
          className="bodyContent_partthree_inner_one"
          style={bodyContent_partthree_inner_one}
        >
          <img
            src={leftlady}
            alt="Notebook"
            className="bodyContent_partthree_inner_inner"
            style={bodyContent_partthree_inner_inner}
          />
          <h4
            className="parthtree_label_heading"
            style={parthtree_label_heading}
          >
            Eileen Johnson
          </h4>
          <p className="parthtree_label_para" style={parthtree_label_para}>
            Executive Chef,USA
          </p>
        </div>
        ...
        <div>
          <div className="parent_background" style={parent_background}>
            <img
              src={Menpic}
              alt="Notebook"
              className="bodyContent_partthree_inner_inner2"
              style={bodyContent_partthree_inner_inner2}
            />
        ...
        >
          ...
          <p className="parthtree_label_para" style={parthtree_label_para3}>
            Sous Chef,India
          </p>
        </div>
      </div>
